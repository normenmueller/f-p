...
package object netty {
  ...
  implicit def wrappedToNettyWrapper(wrp: WrappedMsg[NettyContext]): NettyWrapper =
  ...
  private[netty] final case class Connected(channel: Channel, worker: EventLoopGroup) extends State
